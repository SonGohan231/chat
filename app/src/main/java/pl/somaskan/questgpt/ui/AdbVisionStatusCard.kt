            ...
            Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.spacedBy(14.dp)) {
                Row(Modifier.weight(1f), horizontalArrangement = Arrangement.spacedBy(7.dp)) {
                    ...
                    Column {
                        ...
                        if (!compact) Text("0,5–2 FPS, tylko lokalnie dopóki GPT nie potrzebuje klatki", style = MaterialTheme.typography.bodySmall)
                    }
                }
                Row(Modifier.weight(1f), horizontalArrangement = Arrangement.spacedBy(7.dp)) {
                    Switch(
                    ...
                    Column {
                        ...
                        if (!compact) Text("Tap, swipe, tekst, Back/Home i uruchamianie aplikacji", style = MaterialTheme.typography.bodySmall)
                    }
                }
            }
